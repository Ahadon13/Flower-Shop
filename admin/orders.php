...
$ordersQuery = "SELECT o.* FROM orders o" . $whereClause . " ORDER BY o.order_date DESC LIMIT ? OFFSET ?";
...
<div class="customer-orders-details-orders-container">
    ...
    <div class="customer-orders-search-results-info">
        <div class="customer-orders-search-results-text">
            Found <?= $totalRecords ?> order<?= $totalRecords != 1 ? 's' : '' ?>
            <?php
                $filters = [];
                ...
                ?>
            (Showing page <?= $currentPage ?> of <?= ceil($totalRecords / $recordsPerPage) ?>)
        </div>
    ...
    <div class="customer-orders-search-results-info">
        <div class="customer-orders-search-results-text">
            Total: <?= $totalRecords ?> order<?= $totalRecords != 1 ? 's' : '' ?>
            (Showing page <?= $currentPage ?> of <?= ceil($totalRecords / $recordsPerPage) ?>)
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="pagination-container">
        <?php renderPagination($totalRecords, $recordsPerPage, $currentPage, buildPaginationUrl()); ?>
    </div>
    <?php endif; ?>
